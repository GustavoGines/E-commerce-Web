...
<div class="{{ $compact ? 'mt-3' : 'mt-4' }} w-full">
    @if($product->stock > 0)
        <div class="flex {{ $compact ? 'flex-col items-center gap-2' : 'items-center gap-4' }} w-full">
            ...
            <div class="flex items-center border border-gray-200 dark:border-gray-700 rounded-xl bg-gray-50 dark:bg-gray-800/50 p-1 flex-shrink-0 w-full justify-between">

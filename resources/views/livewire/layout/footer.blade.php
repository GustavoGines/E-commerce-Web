...
<footer class="w-full mt-auto relative z-10 {{ $theme === 'luxury' ? 'bg-[#030712] border-t border-white/5' : 'bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800' }} transition-colors duration-300">
    @if($theme === 'luxury')
    ...
    @else
        ...
        <div class="border-y border-gray-200 bg-gray-50 dark:bg-slate-800/50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-slate-700">
                    
                    {{-- Bloque 1: Retiro en Local --}}
                    <div class="flex flex-col items-center justify-center p-4">
                        <div class="w-12 h-12 rounded-full bg-red-100 dark:bg-red-900/30 text-[var(--color-primary)] flex items-center justify-center mb-4">
                            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                            </svg>
                        </div>
                        <h4 class="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest mb-1">Retiro por Sucursal</h4>
                        <p class="text-xs text-gray-500 dark:text-gray-400 font-medium">Comprá online y pasá a retirar por nuestro local al instante.</p>
                    </div>

                    {{-- Bloque 2: WhatsApp --}}
                    <div class="flex flex-col items-center justify-center p-4">
                        <div class="w-12 h-12 rounded-full bg-green-100 dark:bg-green-900/30 text-green-600 flex items-center justify-center mb-4">
                        ...
                        <h4 class="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest mb-1">¿Dudas? Consultanos</h4>
                        <a href="https://wa.me/5493704291550" target="_blank" class="text-xs font-bold text-green-600 hover:text-green-700 hover:underline">
                            +54 9 370 429-1550
                        </a>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center p-4">
                        <div class="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 flex items-center justify-center mb-4">
                            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                            </svg>
                        </div>
                        <h4 class="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest mb-1">Compra 100% Segura</h4>
                        <p class="text-xs text-gray-500 dark:text-gray-400 font-medium">Protegemos tus datos y garantizamos tu reserva.</p>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li>
                            <a href="https://wa.me/5493704291550" target="_blank" class="flex items-center gap-3 text-gray-500 hover:text-green-600 transition-colors group">
                                ...
                                <div>
                                    ...
                                    <span class="text-sm font-bold">3704291550</span>
                                </div>
                            </a>
                        </li>
                        <li>
        ...
        <a href="https://wa.me/5493704291550" target="_blank" 

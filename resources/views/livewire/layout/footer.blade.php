...
<footer class="w-full mt-auto relative {{ $theme === 'luxury' ? 'bg-[#030712] border-t border-white/5' : 'bg-gray-950 text-gray-400' }} transition-colors duration-300">
    ...
    @else
        ...
        <div class="border-t border-gray-200 bg-white overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
                ...
                <div class="lg:col-span-1 flex flex-col items-center md:items-start text-center md:text-left">
                    <div class="mb-4 relative h-12 w-full flex justify-center md:justify-start items-center">
                        @php $settings = \App\Models\StoreSetting::getSettings(); @endphp
                        @if(isset($settings) && $settings->logo_url)
                            <img src="{{ asset('storage/logos/logo-cjg-horizontal.png') }}" alt="Logo" class="pointer-events-none drop-shadow-md brightness-0 invert opacity-90" style="max-height: 38px; width: auto;">
                        @else
                            <div class="flex items-center gap-2">
                                ...
                                <h4 class="text-xl font-black text-white tracking-tight">{{ $storeName }}</h4>
                            </div>
                        @endif
                    </div>
                ...
                <div class="text-center md:text-left">
                    ...
                    <ul class="space-y-4 mb-6 inline-block md:block text-left">
                        @if(isset($this->social['whatsapp']) && !empty($this->social['whatsapp']))
                            @php
                                $waNumber = preg_replace('/[^0-9]/', '', $this->social['whatsapp']);
                                $waLink = $waNumber ? 'https://wa.me/' . $waNumber : '#';
                            @endphp
                            <li>
                                <a href="{{ $waLink }}" target="_blank" class="flex items-center gap-3 text-gray-400 hover:text-green-400 transition-colors group">
                                    <div class="w-8 h-8 rounded-full bg-white/5 border border-white/10 group-hover:bg-green-500/20 group-hover:border-green-500/30 flex items-center justify-center transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-sm font-bold text-gray-300">{{ $this->social['whatsapp'] }}</span>
                                    </div>
                                </a>
                            </li>
                        @endif
                        <li>
                            <a href="mailto:jcgelectronicaoficial@gmail.com" class="flex items-center gap-3 text-gray-400 hover:text-red-400 transition-colors group">
                                <div class="w-8 h-8 rounded-full bg-white/5 border border-white/10 group-hover:bg-red-500/20 group-hover:border-red-500/30 flex items-center justify-center transition-colors">
                                ...
                                <div>
                                    ...
                                    <span class="text-sm font-bold text-gray-300">jcgelectronica...</span>
                                </div>
                            </a>
                        </li>
                    </ul>

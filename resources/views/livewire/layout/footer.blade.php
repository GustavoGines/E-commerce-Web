            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
                ...
                <div class="text-center md:text-left">
                    ...
                    <div class="flex flex-row flex-wrap justify-center md:justify-start gap-4 mb-6">
                        ...
                        @endif
                        <a href="mailto:jcgelectronicaoficial@gmail.com" class="flex items-center gap-2 text-gray-400 hover:text-red-400 transition-colors group">
                            ...
                            <div class="text-left">
                                ...
                                <span class="text-xs sm:text-sm font-bold text-gray-300">jcgelectronica...</span>
                            </div>
                        </a>
                    </div>
                </div>

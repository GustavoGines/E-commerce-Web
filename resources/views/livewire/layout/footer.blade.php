                ...
                <div class="flex md:grid md:grid-cols-3 gap-4 md:gap-8 overflow-x-auto snap-x snap-mandatory hide-scrollbar px-4 sm:px-0 text-center md:divide-x divide-gray-200 dark:divide-slate-700">
                    ...
                    @if(isset($this->social['whatsapp']))
                        <div class="flex flex-col items-center justify-center p-4 min-w-[250px] snap-center bg-white md:bg-transparent rounded-2xl md:rounded-none shadow-sm md:shadow-none border md:border-none border-gray-100">
                            ...
                            <a href="{{ $this->social['whatsapp'] }}" target="_blank" class="text-[10px] md:text-xs font-bold text-green-600 hover:text-green-700 hover:underline">
                                WhatsApp Aquí
                            </a>
                        </div>
                    @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        @if(isset($this->social['whatsapp']))
                            <li>
                                <a href="{{ $this->social['whatsapp'] }}" target="_blank" class="flex items-center gap-3 text-gray-500 hover:text-green-600 transition-colors group">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-sm font-bold">Contactar</span>
                                    </div>
                                </a>
                            </li>
                        @endif
                        ...
                        @if(isset($this->social['instagram']))
                            <li>
                                <a href="{{ $this->social['instagram'] }}" target="_blank" class="flex items-center gap-3 text-gray-500 hover:text-pink-600 transition-colors group">
                                    <div class="w-8 h-8 rounded-full bg-gray-100 group-hover:bg-pink-100 flex items-center justify-center transition-colors">
                                    ...
                                    <div>
                                        <span class="block text-[10px] font-bold uppercase tracking-widest text-gray-400">Instagram</span>
                                        <span class="text-sm font-bold">Seguinos</span>
                                    </div>
                                </a>
                            </li>
                        @endif
                        ...
                        @if(isset($this->social['facebook']))
                            <li>
                                <a href="{{ $this->social['facebook'] }}" target="_blank" class="flex items-center gap-3 text-gray-500 hover:text-blue-600 transition-colors group">
                                    ...
                                    <div>
                                        <span class="block text-[10px] font-bold uppercase tracking-widest text-gray-400">Facebook</span>
                                        <span class="text-sm font-bold">Seguinos</span>
                                    </div>
                                </a>
                            </li>
                        ...
                        @if(isset($this->social['tiktok']))
                            <li>
                                <a href="{{ $this->social['tiktok'] }}" target="_blank" class="flex items-center gap-3 text-gray-500 hover:text-black transition-colors group">
                                    ...
                                    <div>
                                        <span class="block text-[10px] font-bold uppercase tracking-widest text-gray-400">TikTok</span>
                                        <span class="text-sm font-bold">Videos</span>
                                    </div>
                                </a>
                            </li>
                        @endif

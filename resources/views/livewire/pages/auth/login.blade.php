...
<div>
    ...
    <form wire:submit="login" class="space-y-4">
        ...
        <div x-data="{ show: false }">
            ...
            <div class="relative">
                <x-text-input wire:model="form.password" id="password" class="block mt-1 w-full py-2.5 pl-4 pr-10"
        ...
        <div class="flex items-center justify-between pt-1">
            @if (Route::has('password.request'))
                <a class="text-sm font-medium text-[var(--color-primary)] hover:opacity-80 transition-opacity" href="{{ route('password.request') }}" wire:navigate>
        ...
        <div class="pt-3">
            <div class="relative">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-3 bg-white dark:bg-gray-800 text-gray-500 rounded-full">O continuar con</span>
                </div>
            </div>

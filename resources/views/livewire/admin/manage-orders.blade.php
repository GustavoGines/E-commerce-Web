            ...
            <div class="overflow-x-auto rounded-2xl border border-gray-200 dark:border-gray-700/50 shadow-sm transition-colors">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700/50 text-left">
                    ...
                    <tbody class="bg-white dark:bg-transparent divide-y divide-gray-200 dark:divide-gray-700/50 transition-colors">
                        ...
                        {{-- UX-06 FIX: x-data en el <tr> de cada fila (no en <tbody>). Un solo <tbody> semánticamente válido. --}}
                        ...
                        {{-- Items Dropdown (Alpine) — fila expandible por orden --}}
                        <tr x-show="expanded" x-data class="bg-gray-50/50 dark:bg-gray-800/10" x-transition x-cloak>
                            <td colspan="6" class="px-6 py-4">
                                <div class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3">Detalles de la Orden (Rol: {{ $order->role_applied }})</div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    ...
                                    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3">
                                        <h4 class="text-xs font-bold text-gray-400 uppercase mb-1">Contacto</h4>
                                    ...
                                    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3">
                                        <h4 class="text-xs font-bold text-gray-400 uppercase mb-1">MercadoPago</h4>
                                        <div class="text-sm text-gray-700 dark:text-gray-300">
                                            <strong>Operación ID:</strong> {{ $order->mp_payment_id ?: 'Pendiente' }}<br>
                                            <strong>Preferencia:</strong> <span class="font-mono text-xs">{{ $order->mp_preference_id ?: 'N/A' }}</span>
                                        </div>
                                    </div>
                                </div>

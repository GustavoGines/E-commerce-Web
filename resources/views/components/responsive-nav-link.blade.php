...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-[var(--color-primary)] text-start text-base font-bold text-[var(--color-primary)] bg-[var(--color-primary)]/10 focus:outline-none transition duration-150 ease-in-out'
